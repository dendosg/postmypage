...
export class PostcontentService {
  ...
  public uploadOneImage(url_image, access_token) {
    ...
    return this._http.post('http://139.180.211.217:3000?url=https://graph.facebook.com/v2.11/me/photos', data)
  }
  ...
  public postStatus(scheduled_publish_time, content, access_token): Observable<any> {
    ...
    return this._http.post("http://139.180.211.217:3000?url=" + query, option)
  }
